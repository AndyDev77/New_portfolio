...
const Testimonials = ({ data, direction, speed, pauseOnHover }: TestimonialProps) => {
  return (
        ...
        {data.map((val) => (
          ...
          >
            <div className="relative">
              ...
              <p className="md:line-clamp-4 line-clamp-3 opacity-90 md:text-xl">{val.review}</p>
            </div>
            <div className="flex gap-3 pt-6">
              ...
              <div>
                ...
                <h5 className="md:text-sm text-xs opacity-60">{val.position}</h5>
              </div>
            </div>
