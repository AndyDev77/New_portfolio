          ...
          <div className="bg-black/80 w-11/12 md:w-1/2 h-4/5 md:h-[90%] overflow-hidden rounded-xl">
            {singleProject && (
              <div className="relative ">
                ...
                <Image
                  src={singleProject.image.url} // Make sure 'image' is a string URL
                  width={300}
                  height={300}
                ...
                <div className="p-3">
                  <div className="flex items-center justify-between">
                    <h5 className="text-4xl font-bold">{singleProject.title}</h5>
                    <div className="flex items-center gap-4">
                      ...
                      <Link href={singleProject.liveurl} target="_blank" rel="noopener noreferrer">
                        <ExternalLink />
                      </Link>
                    </div>
                  </div>
                  ...
                  <p className="text-white/50">
                    {singleProject.descr} {/* Use the description from singleProject */}
                  </p>
                </div>
              </div>
            )}
